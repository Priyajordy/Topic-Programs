...
int main()
{
    ...
    delete obj; // deallocate the memory for obj (explicit call karav lagato)
    // Destructor call zala ya line mule
    // objectchi memory ethe free zali..

    // yachya khali 500 lines cha code ahe
